...
def log_invoice_save(sender, instance, created=False, **kwargs):
    if created:
        event_logger.paypal_invoice.info(
            '{start_date}-{end_date}. Invoice for customer {customer_name} has been created.',
        ...
        event_logger.paypal_invoice.info(
            '{start_date}-{end_date}. Invoice for customer {customer_name} has been updated.',
...
def log_invoice_delete(sender, instance, **kwargs):
    event_logger.paypal_invoice.info(
        '{start_date}-{end_date}. Invoice for customer {customer_name} has been deleted.',
